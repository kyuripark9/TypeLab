/* TypeLab — starting styles, navigation, and the plain-language description of every control. */
(function (TL) {
  'use strict';
  const D = TL.DEFAULTS;
  const style = (id, name, tags, desc, p) => ({ id, name, tags, desc, params: Object.assign({}, D, p) });
  ...
  TL.TERMINALS = [['flat', 'Flat'], ['round', 'Rounded'], ['sharp', 'Sharp'], ['angled', 'Angled'], ['cut', 'Cut'], ['tapered', 'Tapered']];
  TL.SERIF_SHAPES = [['bracketed', 'Bracketed'], ['unbracketed', 'Unbracketed'], ['slab', 'Slab'], ['wedge', 'Wedge']];
