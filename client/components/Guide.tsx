...
const STEPS: Step[] = [
  ...
  { target: 'stage', side: 'right', category: 'style', title: 'Starting styles',
    body: 'Choose a style to begin with. Filter by classification or feeling.' },
  ...
  { target: 'stage', side: 'right', category: 'structure', title: 'Live preview',
    body: 'Click any letter to see its anatomy. Switch the sample text and size in the bar above.' },
